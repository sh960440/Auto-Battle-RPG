...
namespace Combat.Tests
{
    public class CombatSimulatorTests
    {
        ...
        public void Duel_PlayerWinsAgainstWeakerEnemy()
        {
            ...
            var player = CreateUnit("Knight", hp: 100, attack: 20, defense: 5, speed: 10, isPlayer: true, rules);
        ...
        {
            var rules = CombatRules.CreateRuntimeDefaults();
            var player = CreateUnit("Knight", hp: 50, attack: 10, defense: 0, speed: 10, isPlayer: true, rules);
        ...
        {
            var rules = CombatRules.CreateRuntimeDefaults();
            var unit = CreateUnit("Knight", hp: 100, attack: 10, defense: 0, speed: 10, isPlayer: true, rules);
        ...
        {
            var rules = CombatRules.CreateRuntimeDefaults();
            var player = CreateUnit("Knight", hp: 100, attack: 50, defense: 0, speed: 100, isPlayer: true, rules);
